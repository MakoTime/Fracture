...
from tools.widgets import NameField, IntegerVector3Widget, VisibleWidget
...
class MeshProceduralView(TabEditorView):
    ...
    def __init__(
        ...
        overwrite_seed_button.setToolTip("Overwrite the seed of the selected noise object")
