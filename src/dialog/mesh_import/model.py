...
from src.application.importers import register_import_binding
from src.engine.block_objects import MeshBlockObject
from src.engine.block_tasks import MeshImportTask
...
class MeshImportModel:
    ...
    def bind_controller(object_importer, tree_view, parent=None, engine_runner=None):
        ...
        from src.application.importers import MeshImportController
