...
from src.components.table import TableManager, TableModel, TableView
from src.components.tree import TreeModel
...
from src.dialog.mesh_mask import SurfaceMaskModel
from src.dialog.mesh_mask.view import MaskCanvas
...
from src.engine.block_tasks.generated_mesh import GeneratedMeshTask
...
def test_generate_mesh_opens_standalone_window(qapp):
    ...
    import src.dialog.mesh_generate.view as generate_view
...
def test_island_registers_orbit_shape_with_orbit_icon_button(qapp):
    ...
    from src.components.tree import TreeManager
    from src.engine.block_objects import (
        IslandBlockObject,
        MeshBlockObject,
...
def test_scene_uses_unique_actor_names_for_multiple_islands():
    ...
    from src.components.scene.view import SceneViewer
    from src.engine.block_objects import (
        IslandBlockObject,
        MeshBlockObject,
        WorldConfigBlockObject,
